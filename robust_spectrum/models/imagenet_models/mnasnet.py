...
def robust_mnasnet1_0_l2_3(pretrained=False, progress=True, **kwargs):
    """MNASNet with depth multiplier of 1.0 from
    `"MnasNet: Platform-Aware Neural Architecture Search for Mobile"
    <https://arxiv.org/pdf/1807.11626.pdf>`_.

    This is robust MNASNet trained to on L2 perturbations of size 3 by Engstrom
    et al. 2019.  Pretrained is always false since weights must be loaded.
